...
:class: tip
- Use the principle of reciprocity to connect BF-STEM and HRTEM.
- Explain the lateral image shifts between off-axis virtual bright-field images.
- Fit the aberration surface from the measured shifts, and use it to correct the image.
:::
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://githubtocolab.com/curiousbeams/workshop-20260810-iucr-4dstem/blob/main/notebooks/try-it-yourself/02.parallax_01.ipynb) and [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://githubtocolab.com/curiousbeams/workshop-20260810-iucr-4dstem/blob/main/notebooks/try-it-yourself/03.parallax_02.ipynb)
```
