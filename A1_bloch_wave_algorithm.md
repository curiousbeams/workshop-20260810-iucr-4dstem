...
:class: tip
- Apply Bloch's theorem to build a basis that respects the crystal periodicity.
- Set up the Bloch-wave eigenvalue problem and interpret the excitation error.
- Compute SAED, CBED and PACBED patterns as a function of thickness and tilt.
:::
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://githubtocolab.com/curiousbeams/workshop-20260810-iucr-4dstem/blob/main/notebooks/try-it-yourself/08.dynamical_diffraction_01.ipynb)
```
