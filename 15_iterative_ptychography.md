...
:class: tip
- Walk through the ePIE update step for the object and the probe.
- Know the standard forward-model extensions: multislice, mixed-state, and joint reconstructions.
- Recognize which hyperparameters matter and how a reconstruction fails when they are wrong.
:::
