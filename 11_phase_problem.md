...
:class: tip
- State the phase problem and why our detectors lose the phase in the first place.
- Compare HRTEM phase-contrast strategies: defocus, and Zernike, Boersch, Volta and laser phase plates.
- Recognize the weak-phase-object approximation and its range of validity.
:::
