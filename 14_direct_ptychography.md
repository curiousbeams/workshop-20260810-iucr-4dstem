...
:class: tip
- Describe the double-overlap (trotter) region of the four-dimensional dataset and how single side-band uses it.
- Deconvolve the effect of the probe from a 4D-STEM dataset.
- Treat aberration fitting as a least-squares problem on the measured phase.
:::
